...
\fancyfoot[L]{\emph{ADD YOUR SHORT PROJECT DESCRIPTION HERE}} % except the center
\fancyfoot[R]{\thepage}
...
\fancyfoot[LO,LE]{\emph{ADD YOUR SHORT PROJECT DESCRIPTION HERE}}
\cfoot{}
...
\input{project/project-design.tex} % adds the Project Design
\input{project/implementation.tex} % adds the Project Design
\input{project/schedule.tex} % adds the Scheduling and Planning page
